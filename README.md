...
## Data
The cleaned dataset has been split into CSVs for upload to github repo. They can be loaded into dataframes and merged using pd.concat (see dataload notebook). 
...
<br>
3. Phase I_Load from Split CSVs
